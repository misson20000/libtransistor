...
#define LIBTRANSISTOR_ERR_TARGET_VERSION_NOT_SET LIBTRANSISTOR_RESULT(8)
#define LIBTRANSISTOR_ERR_TARGET_VERSION_ALREADY_SET LIBTRANSISTOR_RESULT(9)
#define LIBTRANSISTOR_ERR_TARGET_VERSION_NOT_SUPPORTED LIBTRANSISTOR_RESULT(10)
...
#define LIBTRANSISTOR_ERR_SM_SERVICE_OVERRIDDEN LIBTRANSISTOR_RESULT(2003)
